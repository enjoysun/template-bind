 ...
 */
public class TemplateRejectedExecution implements RejectedExecutionHandler {
    private Logger log = LoggerFactory.getLogger(TemplateRejectedExecution.class.toString());
